...
CHECKPOINT_DIR = os.path.join(ACTION_SEG_CHECKPOINT_DIR, 'coarse-inputs-boundary-end')
LOG_DIR = os.path.join(ACTION_SEG_LOG_DIR, 'coarse-inputs-boundary-end')
CONFIG_DIR = os.path.join(ACTION_SEG_CONFIG_DIR, 'coarse-inputs-boundary-end')
SUBMISSION_DIR = os.path.join(ROOT_DIR, 'submissions/action-segmentation/coarse-input-boundary-end-temp')
NUM_WORKERS = 2
    ...
    def __getitem__(self, idx):
        ...
        for i in range(1, video_len):
            ...
            if prev_logit != curr_logit:
                coarse_features[boundary_idx, i-1] = 1
