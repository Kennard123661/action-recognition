...
class TrainDataset(tdata.Dataset):
    ...
    def collate_fn(batch):
        ...
        padded_features = torch.zeros(len(features), IN_CHANNELS+1, max_video_length, dtype=torch.float)
        ...
        for i, feature in enumerate(features):
            ...
            padded_features[i, :IN_CHANNELS, :video_len] = feature
            padded_features[i, IN_CHANNELS, :] = torch.arange(max_video_length) / video_len
