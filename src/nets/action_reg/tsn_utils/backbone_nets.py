...
class BNInception(nn.Module):
    def __init__(self, n_input_channels, bn_eval=True, bn_frozen=False, partial_bn=False):
        ...
        inplace = True
        self.conv1_7x7_s2 = nn.Conv2d(self.n_input_channels, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3))
    ...
    def init_weights(self):
        if self.pretrained:
            model_state_dict = torch.load(self.pretrained)['state_dict']
    ...
    def conv1(self, inputs):
        conv1_7x7_s2_out = self.conv1_7x7_s2(inputs)
        conv1_7x7_s2_bn_out = self.conv1_7x7_s2_bn(conv1_7x7_s2_out)
        return conv1_7x7_s2_bn_out

    def forward(self, inputs):
        # conv1
        conv1_7x7_s2_bn_out = self.conv1(inputs)
